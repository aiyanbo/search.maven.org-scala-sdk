...
/**
 * Component: Description: Date: 15/9/17
 *
 * @author
 * Andy.Ai
 */
case class MavenSearchRequest(
...
object MavenSearchRequest {
  ...
  def apply(groupId: String, artifactId: String): MavenSearchRequest =
    new MavenSearchRequest(Option(groupId), Option(artifactId), None)
